...
#if ANY(FSMC_GRAPHICAL_TFT, SPI_GRAPHICAL_TFT, LTDC_GRAPHICAL_TFT)
...
#elif EITHER(TFT_1024x600_LTDC, LTDC_GRAPHICAL_TFT)
  #define HAS_LTDC_TFT 1
#endif

// Color UI
#if ANY(TFT_320x240, TFT_480x320, TFT_320x240_SPI, TFT_480x320_SPI, TFT_1024x600_LTDC)
