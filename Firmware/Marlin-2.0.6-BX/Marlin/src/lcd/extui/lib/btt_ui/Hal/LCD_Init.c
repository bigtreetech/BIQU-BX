...
{
  #ifdef LCD_LED_PWM_CHANNEL
    //pinmap_pinout(digitalPin[LCD_LED_PIN], PinMap_PWM);
...
#define SSD_HOR_RESOLUTION   BTT_LCD_WIDTH  // LCD width pixel
#define SSD_VER_RESOLUTION   BTT_LCD_HEIGHT // LCD height pixel
