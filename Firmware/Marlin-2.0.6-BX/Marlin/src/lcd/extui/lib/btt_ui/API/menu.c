...
const GUI_RECT rect_of_key[MENU_RECT_COUNT]={
  ...
  //title bar area
  {0 ,0 ,BTT_LCD_WIDTH, ICON_START_Y},
};
...
void menuClearGaps(void)
{
  ...
  {0,                  0,                  BTT_LCD_WIDTH,          TITLE_END_Y},
  {0,                  TITLE_END_Y,        BTT_LCD_WIDTH,          rect_of_key[0].y0},
  {0,                  rect_of_key[0].y0,  rect_of_key[0].x0,  BTT_LCD_HEIGHT},
  {rect_of_key[0].x1,  rect_of_key[0].y0,  rect_of_key[1].x0,  BTT_LCD_HEIGHT},
  {rect_of_key[1].x1,  rect_of_key[0].y0,  rect_of_key[2].x0,  BTT_LCD_HEIGHT},
  {rect_of_key[2].x1,  rect_of_key[0].y0,  rect_of_key[3].x0,  BTT_LCD_HEIGHT},
  {rect_of_key[3].x1,  rect_of_key[0].y0,  BTT_LCD_WIDTH,          BTT_LCD_HEIGHT}};

  const GUI_RECT gapsSS[]={
  {0,                   0,                    BTT_LCD_WIDTH,            TITLE_END_Y},
  {0,                   TITLE_END_Y,          BTT_LCD_WIDTH,            rect_of_keySS[0].y0},
  {0,                   rect_of_keySS[0].y0,  rect_of_keySS[0].x0,  BTT_LCD_HEIGHT},
  {rect_of_keySS[4].y0, rect_of_keySS[0].y0,  BTT_LCD_WIDTH,            BTT_LCD_HEIGHT},
  //1ST ROW
...
static REMINDER reminder = {{0, 0, BTT_LCD_WIDTH, TITLE_END_Y}, 0, STATUS_NORMAL, LABEL_BACKGROUND};
static REMINDER volumeReminder = {{0, 0, BTT_LCD_WIDTH, TITLE_END_Y}, 0, STATUS_IDLE, LABEL_BACKGROUND};
static REMINDER busySign = {{BTT_LCD_WIDTH - 5, 0, BTT_LCD_WIDTH, 5}, 0, STATUS_BUSY, LABEL_BUSY};
...
void menuDrawTitle(const uint8_t *content) //(const MENUITEMS * menuItems)
{
  ...
  if (content)
  {
    GUI_DispLenString(10, start_y, content, BTT_LCD_WIDTH - 20);
    start_x += GUI_StrPixelWidth(content);
    if (start_x > BTT_LCD_WIDTH-20) start_x = BTT_LCD_WIDTH - 20;
  }
...
void menuDrawListPage(const LISTITEMS *listItems)
{
  ...
  GUI_SetBkColor(infoSettings.bg_color);
  GUI_ClearRect(0, TITLE_END_Y, BTT_LCD_WIDTH, BTT_LCD_HEIGHT);
